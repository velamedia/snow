...
$csv_file = array('id'=>'csv_file','name'=>'csv_file'); 


$form_attributes = array('id' => 'inquiry_csv_upload_form', 'enctype'=>"multipart/form-data");
...
?>
    ...
    <table>
        ...
        <tr>
            <td><span class="labels">Upload CSV File with the items</span></td>
            <td><?php echo form_upload($csv_file); ?></td>
        </tr>
        <tr><td><br /></td></tr>
    </table>
