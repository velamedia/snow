...
//input fields 
$sales_ref = array('id'=>'sales_ref','name'=>'sales_ref','type'=>'text','value' => $inquiry[0]['sales_ref'],'disabled'=>'disabled'); 
$title = array('id'=>'title','name'=>'title','type'=>'text','value' => $inquiry[0]['title']); 
$customer = array('id'=>'customer','name'=>'customer','type'=>'text','value' => $inquiry[0]['customer']); 
$location = array('id'=>'location','name'=>'location','type'=>'text','value' => $inquiry[0]['location']); 
$date_of_inquiry = array('id'=>'date_of_inquiry','name'=>'date_of_inquiry','type'=>'text','value' => date('Y-m-d', strtotime($inquiry[0]['date_of_inquiry'])));
